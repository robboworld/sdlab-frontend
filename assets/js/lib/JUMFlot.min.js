...
options:{series:{spiral:{active:!1,show:!1,spiralSize:0.8,rotations:3,steps:36,delay:50,highlight:{opacity:0.5}}}},name:"spiral",version:"0.3"})})(jQuery);(function(e){var x={series:{nearBy:{distance:6,findItemDefault:null,findMode:"circle",drawHover:null}}};e.plot.plugins.push({init:function(u){function r(a,c,d,h){!0===c.heatmap.show&&(c.nearBy.findItemDefault=c.nearBy.findItem,c.nearBy.findItem=q);if((c.heatmap.show===true)&&m.series.heatmap.backImage){(new Image).src=m.series.heatmap.backImage;}}function t(a,c){var d;m.series.heatmap.backImage&&(d=m.series.heatmap.backImage,k=a.getPlotOffset(),c.save(),c.translate(k.left,k.top),c.drawImage(d,0,0,a.width(),a.height()),c.restore())}function p(b,c,d){if(d.heatmap.show!==true)return;a=document.createElement("canvas");
