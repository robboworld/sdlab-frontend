 ...
 * Html widgets
 * 
 * @see JHtml in Joomla.Libraries.HTML (/libraries/cms/html/html.php)
 * @see JHtmlSelect in Joomla.Libraries.HTML (/libraries/cms/html/select.php)
 */
class Html
{
	/**
	 ...
	 * @var    array
	 * 
	 * @see JHtml::$formatOptions in Joomla.Libraries.HTML (/libraries/cms/html/html.php)
	 */
	 ...
	 * @return  object
	 *
	 * @see JHtmlSelect::option() in Joomla.Libraries.HTML (/libraries/cms/html/select.php)
	 */
	 ...
	 *                            Selection options. See {@see Html::options()}.
	 ...
	 * 
	 * @see JHtmlSelect::groupedlist() in Joomla.Libraries.HTML (/libraries/cms/html/select.php)
	 */
	public static function groupedlist($data, $name, $options = array())
	{
		...
		if (isset($options['list.attr']))
		{
			...
			{
				$attribs = System::arrayToString($options['list.attr']);
			}
			else
			{
	 ...
	 * @return  string  HTML for the select list
	 *
	 * @see JHtmlSelect::options() in Joomla.Libraries.HTML (/libraries/cms/html/select.php)
	 */
		...
		foreach ($arr as $elementKey => &$element)
		{
			...
			*/
			...
			else
			{
				...
				if (is_array($attr))
				{
					$attr = System::arrayToString($attr);
				}
				else
				{
					$attr = trim($attr);
