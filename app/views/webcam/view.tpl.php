...
?>
<?php if (isset($this->view->content->item)) : ?>
	...
	<form id="sdform" method="post" action="?<?php echo $_SERVER['QUERY_STRING']; ?>" class="form-horizontal">
		...
		<div class="btn-toolbar" role="toolbar">
			<div class="btn-group btn-group-sm" role="group">
				<button type="button" class="webcam-stream-on btn btn-primary" data-devid="<?php echo (int)$this->view->content->item->Index; ?>"><span class="glyphicon glyphicon-off"></span></button>
				<button type="button" class="webcam-stream-off btn btn-default" data-devid="<?php echo (int)$this->view->content->item->Index; ?>"><span class="glyphicon glyphicon-ban-circle"></span></button>
			</div>
			<?php if ($streamed) : ?>

			<div class="btn-group btn-group-sm btn-group-streamplay" role="group">
				<button type="button" class="webcam-stream-start btn btn-xs btn-success" data-devid="<?php echo (int)$this->view->content->item->Index; ?>"><span class="glyphicon glyphicon-play"></span></button>
				<button type="button" class="webcam-stream-step-forward btn btn-xs btn-success" data-devid="<?php echo (int)$this->view->content->item->Index; ?>"><span class="glyphicon glyphicon-step-forward"></span></button>
				<button type="button" class="webcam-stream-stop btn btn-xs btn-danger" data-devid="<?php echo (int)$this->view->content->item->Index; ?>"><span class="glyphicon glyphicon-stop"></span></button>
			</div>
			<button type="button" class="webcam-stream-fast-forward btn btn-sm btn-success" data-devid="<?php echo (int)$this->view->content->item->Index; ?>" style="display:none;"><span class="glyphicon glyphicon-fast-forward"></span></button>
			<button type="button" class="webcam-stream-step btn btn-sm btn-primary" data-devid="<?php echo (int)$this->view->content->item->Index; ?>" style="display:none;"><span class="glyphicon glyphicon-picture"></span></button>
			<?php endif; ?>
